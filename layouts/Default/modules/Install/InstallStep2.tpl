			...
			<div class="col-md-6">
				<div class="form-group">
					<label for="inputEmail3"
						   class="col-sm-4 col-form-label">{\App\Language::translate('LBL_CRM_PATH', $MODULE_NAME)}</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="inputEmail3"
						   class="col-sm-4 col-form-label">{\App\Language::translate('LBL_API_KEY', $MODULE_NAME)}</label>
					<div class="col-sm-8">
