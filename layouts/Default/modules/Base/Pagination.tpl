	...
	{if !(PAGE==1 && !IS_MORE_PAGES) }
		<nav aria-label="Page navigation">
			<ul class="pagination js-pagination-list" data-page="{$PAGE}">
				...
				{if $IS_MORE_PAGES}
					<li class="page-item disabled"><a class="page-link js-page-item" href="#" data-page="{$PAGE + 1}">{$PAGE + 1}</a></li>
					<li class="page-item disabled"><a class="page-link js-page-item" href="#" data-page="{$PAGE + 2}">{$PAGE + 2}</a></li>
				{/if}
