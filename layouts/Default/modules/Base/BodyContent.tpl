...
{strip}
	<div class="container-fluid bodyContent View-{$VIEW}">
		<div class="mainContent">
			<div id="page">
				...
				<input type="hidden" id="numberOfCurrencyDecimal" value="{$USER->getPreferences('no_of_currency_decimals')}" />
				<input type="hidden" id="currencyGroupingSeparator" value="{$USER->getPreferences('currency_grouping_separator')}" />
				<input type="hidden" id="currencyDecimalSeparator" value="{$USER->getPreferences('currency_decimal_separator')}" />
				<input type="hidden" id="currencyGroupingPattern" value="{$USER->getPreferences('currency_grouping_pattern')}" />
