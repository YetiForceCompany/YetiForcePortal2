...
{strip}
	...
	<select id="{$MODULE_NAME}_{$VIEW}_fieldName_{$FIELD_MODEL->getName()}" title="{$FIELD_MODEL->getLabel()}" multiple class="select2 {if !empty($FIELD_MODEL->getNotDisplayValuesList())} hideSelected{/if}"
