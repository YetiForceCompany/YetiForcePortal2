		...
		<div class="input-group">
			<span class="input-group-btn">
				<select class="chzn-select form-control col-md-5"
						title="{\App\Functions::translate('LBL_SEARCH_MODULE', $MODULE_NAME)}"
						id="basicSearchModulesList">
					<option value=""
							class="globalSearch_module_All">{\App\Functions::translate('LBL_ALL_RECORDS', $MODULE_NAME)}</option>
				</select>
			</span>
		</div>
		<div class="input-group">
			<input type="text" class="form-control"
				   title="{\App\Functions::translate('LBL_GLOBAL_SEARCH',$MODULE_NAME)}"
