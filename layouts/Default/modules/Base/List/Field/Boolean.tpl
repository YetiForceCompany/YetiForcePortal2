...
{strip}
	...
	<select name="filters[{$FIELD_MODEL->getName()}]" class="form-control select2 js-filter-field" title="{$FIELD_MODEL->getFieldLabel()}" data-allow-clear="true" data-fieldinfo="{\App\Purifier::encodeHtml(\App\Json::encode($FIELD_MODEL->getFieldInfo()))}">
