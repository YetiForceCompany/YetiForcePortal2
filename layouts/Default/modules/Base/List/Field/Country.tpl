...
<select name="filters[{$FIELD_MODEL->getName()}]" class="select2 form-control js-filter-field" title="{\App\Language::translate($FIELD_MODEL->getFieldLabel(), $MODULE_NAME)}" data-fieldinfo='{\App\Purifier::encodeHtml(\App\Json::encode($FIELD_MODEL->getFieldInfo()))}' {if $FIELD_MODEL->isEditableReadOnly()}readonly="readonly"{/if}>
	{if $PLACE_HOLDER}
		<optgroup class="p-0">
