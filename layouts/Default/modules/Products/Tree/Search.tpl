...
{strip}
    <div class="input-group js-search-group my-3" data-js="change|keyup">
        <div class="input-group-prepend">
             <button class="btn btn-outline-secondary js-search-cancel bmd-btn-icon" type="button">
        ...
        <div class="input-group-append">
         <button class="btn btn-outline-secondary js-search-button bmd-btn-icon" type="button">
