...
// 	contentType: false
// })
AppConnector.request(formData).done(function(response){progress.progressIndicator({mode:'hide'}),response.success&&app.showNotify({text:app.translate('JS_SAVE_NOTIFY_SUCCESS'),type:'success'}),callbackAfterSave(response.result);}).fail(function(textStatus,errorThrown){callbackAfterSave(!1),app.showNotify({text:errorThrown,title:app.translate('JS_ERROR'),type:'error'});})}/**
