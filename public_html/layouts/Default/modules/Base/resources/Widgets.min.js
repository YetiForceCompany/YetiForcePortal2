...
data.datasets=this.loadDatasetOptions(data);var options=this.parseOptions(this.loadBasicOptions(data)),plugins=[];data=this.parseOptions(data);var chart=this.chartInstance=new Chart(this.getChartContainer().find("canvas").get(0).getContext("2d"),{type:type,data:data,options:options,plugins:plugins});// parse chart one more time after it was mounted - some options need to have chart loaded
return data.datasets=data.datasets.map(function(dataset,index){return dataset.datasetIndex=index,_this6.parseOptions(dataset,dataset,!0)}),chart}},{key:"readData",value:function readData(){var container=this.getChartContainer();this.filterIds=JSON.parse(container.find("[name=\"filterIds\"]").val());}},{key:"registerEvents",value:function registerEvents(container){var type=container.find("[name=\"typeChart\"]").val(),stacked=!!Number(container.find("[name=\"stacked\"]").val());stacked&&(type+="Stacked");var classname="Base_Dashboard_ChartFilter_"+type+"_Js";if("undefined"!=typeof window[classname]){var instance=new window[classname];return instance.setChartContainer(container),instance.readData(),instance.loadChart()}console.error("Nie znaleziono "+classname);}}]),_class2}(),window.Base_Dashboard_ChartFilter_Pie_Js=/*#__PURE__*/function(_Base_Dashboard_Chart){function _class3(){return _classCallCheck(this,_class3),_super.apply(this,arguments)}_inherits(_class3,_Base_Dashboard_Chart);var _super=_createSuper(_class3);return _createClass(_class3,[{key:"getType",value:function getType(){return "pie"}}]),_class3}(Base_Dashboard_ChartFilter_Js),window.Base_Dashboard_ChartFilter_Bar_Js=/*#__PURE__*/function(_Base_Dashboard_Chart2){function _class4(){return _classCallCheck(this,_class4),_super2.apply(this,arguments)}_inherits(_class4,_Base_Dashboard_Chart2);var _super2=_createSuper(_class4);return _createClass(_class4,[{key:"getType",value:function getType(){return "bar"}}]),_class4}(Base_Dashboard_ChartFilter_Js),window.Base_Dashboard_ChartFilter_BarStacked_Js=/*#__PURE__*/function(_Base_Dashboard_Chart3){function _class5(){return _classCallCheck(this,_class5),_super3.apply(this,arguments)}_inherits(_class5,_Base_Dashboard_Chart3);var _super3=_createSuper(_class5);return _createClass(_class5,[{key:"getType",value:function getType(){return "barStacked"}}]),_class5}(Base_Dashboard_ChartFilter_Js),window.Base_Dashboard_ChartFilter_Horizontal_Js=/*#__PURE__*/function(_Base_Dashboard_Chart4){function _class6(){return _classCallCheck(this,_class6),_super4.apply(this,arguments)}_inherits(_class6,_Base_Dashboard_Chart4);var _super4=_createSuper(_class6);return _createClass(_class6,[{key:"getType",value:function getType(){return "horizontalBar"}}]),_class6}(Base_Dashboard_ChartFilter_Bar_Js),window.Base_Dashboard_ChartFilter_HorizontalStacked_Js=/*#__PURE__*/function(_Base_Dashboard_Chart5){function _class7(){return _classCallCheck(this,_class7),_super5.apply(this,arguments)}_inherits(_class7,_Base_Dashboard_Chart5);var _super5=_createSuper(_class7);return _createClass(_class7,[{key:"getType",value:function getType(){return "horizontalBar"}},{key:"getSubType",value:function getSubType(){return "horizontalBarStacked"}}]),_class7}(Base_Dashboard_ChartFilter_Horizontal_Js),window.Base_Dashboard_ChartFilter_Funnel_Js=/*#__PURE__*/function(_Base_Dashboard_Chart6){function _class8(){return _classCallCheck(this,_class8),_super6.apply(this,arguments)}_inherits(_class8,_Base_Dashboard_Chart6);var _super6=_createSuper(_class8);return _createClass(_class8,[{key:"getType",value:function getType(){return "funnel"}}]),_class8}(Base_Dashboard_ChartFilter_Js),window.Base_Dashboard_ChartFilter_Donut_Js=/*#__PURE__*/function(_Base_Dashboard_Chart7){function _class9(){return _classCallCheck(this,_class9),_super7.apply(this,arguments)}_inherits(_class9,_Base_Dashboard_Chart7);var _super7=_createSuper(_class9);return _createClass(_class9,[{key:"getType",value:function getType(){return "doughnut"}}]),_class9}(Base_Dashboard_ChartFilter_Pie_Js),window.Base_Dashboard_ChartFilter_Line_Js=/*#__PURE__*/function(_Base_Dashboard_Chart8){function _class10(){return _classCallCheck(this,_class10),_super8.apply(this,arguments)}_inherits(_class10,_Base_Dashboard_Chart8);var _super8=_createSuper(_class10);return _createClass(_class10,[{key:"getType",value:function getType(){return "line"}}]),_class10}(Base_Dashboard_ChartFilter_Js),window.Base_Dashboard_ChartFilter_LineStacked_Js=/*#__PURE__*/function(_Base_Dashboard_Chart9){function _class11(){return _classCallCheck(this,_class11),_super9.apply(this,arguments)}_inherits(_class11,_Base_Dashboard_Chart9);var _super9=_createSuper(_class11);return _createClass(_class11,[{key:"getType",value:function getType(){return "line"}},{key:"getSubType",value:function getSubType(){return "lineStacked"}}]),_class11}(Base_Dashboard_ChartFilter_Line_Js),window.Base_Dashboard_ChartFilter_LinePlain_Js=/*#__PURE__*/function(_Base_Dashboard_Chart10){function _class12(){return _classCallCheck(this,_class12),_super10.apply(this,arguments)}_inherits(_class12,_Base_Dashboard_Chart10);var _super10=_createSuper(_class12);return _createClass(_class12,[{key:"getSubType",value:function getSubType(){return "linePlain"}}]),_class12}(Base_Dashboard_ChartFilter_Line_Js),window.Base_Dashboard_ChartFilter_LinePlainStacked_Js=/*#__PURE__*/function(_Base_Dashboard_Chart11){function _class13(){return _classCallCheck(this,_class13),_super11.apply(this,arguments)}_inherits(_class13,_Base_Dashboard_Chart11);var _super11=_createSuper(_class13);return _createClass(_class13,[{key:"getSubType",value:function getSubType(){return "linePlainStacked"}}]),_class13}(Base_Dashboard_ChartFilter_Line_Js);
