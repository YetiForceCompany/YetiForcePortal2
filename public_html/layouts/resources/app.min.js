...
function _toConsumableArray(arr){return _arrayWithoutHoles(arr)||_iterableToArray(arr)||_unsupportedIterableToArray(arr)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(o,minLen){if(o){if("string"==typeof o)return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);return "Object"===n&&o.constructor&&(n=o.constructor.name),"Map"===n||"Set"===n?Array.from(o):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(o,minLen):void 0}}function _iterableToArray(iter){if("undefined"!=typeof Symbol&&null!=iter[Symbol.iterator]||null!=iter["@@iterator"])return Array.from(iter)}function _arrayWithoutHoles(arr){if(Array.isArray(arr))return _arrayLikeToArray(arr)}function _arrayLikeToArray(arr,len){(null==len||len>arr.length)&&(len=arr.length);for(var i=0,arr2=new Array(len);i<len;i++)arr2[i]=arr[i];return arr2}function _typeof(obj){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(obj){return typeof obj}:function(obj){return obj&&"function"==typeof Symbol&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj},_typeof(obj)}/* {[The file is published on the basis of YetiForce Public License 5.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */var App={Components:{QuickCreate:{/**
			 ...
			 * @param   {object}  params
			 */createRecord:function createRecord(moduleName){var _this=this,params=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{},url="index.php?module="+moduleName+"&view=QuickCreateModal";("DetailView"===app.getViewName()||"EditView"===app.getViewName()&&app.getRecordId())&&(url+="&sourceModule="+app.getModuleName(),url+="&sourceRecord="+app.getRecordId()),"undefined"==typeof params.callbackAfterSave&&(params.callbackAfterSave=function(){"ListView"===app.getViewName()&&app.getModuleName()===moduleName&&"function"==typeof app.pageController.reloadView&&app.pageController.reloadView();});var progress=$.progressIndicator({blockInfo:{enabled:!0}});this.getForm(url,params).done(function(data){progress.progressIndicator({mode:"hide"}),_this.showModal(data,params);});},/**
...
var chosenSelectConainer=jQuery(".chosen-container-multi .default").css("width","100%");return chosenSelectConainer},getUrlParam:function getUrlParam(name){var sParameterName,i,sPageURL=decodeURIComponent(window.location.search.substring(1)),sURLVariables=sPageURL.split("&");for(i=0;i<sURLVariables.length;i++)if(sParameterName=sURLVariables[i].split("="),sParameterName[0]===name)return void 0===sParameterName[1]||sParameterName[1]},generateRandomChar:function generateRandomChar(){var chars,newchar,rand;return chars="0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZ",rand=Math.floor(Math.random()*chars.length),newchar=chars.substring(rand,rand+1)},translate:function translate(key){if(app.languageString[key]!=null)return app.languageString[key];var strings=jQuery("#js_strings").text();return ""!=strings&&(app.languageString=JSON.parse(strings),key in app.languageString)?app.languageString[key]:key},registerDataTables:function registerDataTables(table){var options=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return null!=$.fn.dataTable&&0!=table.length&&($.fn.dataTable.ext.errMode=function(settings,helpPage,message){settings.jqXHR.statusText&&settings.jqXHR.responseJSON.error.message?(alert(settings.jqXHR.statusText+"\r\n"+settings.jqXHR.responseJSON.error.message),console.error(settings.jqXHR.responseJSON.error)):message?alert(message):console.error(settings.jqXHR.responseJSON);},$.extend($.fn.dataTable.defaults,{fixedHeader:!0,dom:"<\"float-left\"B><\"float-right\"f>rt<\"row\"<\"col-sm-4\"l><\"col-sm-4\"i><\"col-sm-4\"p>>",language:{sLengthMenu:app.translate("JS_S_LENGTH_MENU"),sZeroRecords:app.translate("JS_NO_RESULTS_FOUND"),sInfo:app.translate("JS_S_INFO"),sInfoEmpty:app.translate("JS_S_INFO_EMPTY"),sSearch:app.translate("JS_SEARCH"),sEmptyTable:app.translate("JS_NO_RESULTS_FOUND"),sInfoFiltered:app.translate("JS_S_INFO_FILTERED"),sLoadingRecords:app.translate("JS_LOADING_OF_RECORDS"),sProcessing:app.translate("JS_LOADING_OF_RECORDS"),oPaginate:{sFirst:app.translate("JS_S_FIRST"),sPrevious:app.translate("JS_S_PREVIOUS"),sNext:app.translate("JS_S_NEXT"),sLast:app.translate("JS_S_LAST")},oAria:{sSortAscending:app.translate("JS_S_SORT_ASCENDING"),sSortDescending:app.translate("JS_S_SORT_DESCENDING")}}}),table.DataTable(options))},/**
	 ...
	 */registerPopoverManualTrigger:function registerPopoverManualTrigger(element,manualTriggerDelay){var _this2=this,hideDelay=500;element.on("mouseleave",function(){setTimeout(function(){var currentPopover=_this2.getBindedPopover(element);$(":hover").filter(currentPopover).length||currentPopover.find(".js-popover-tooltip--record[aria-describedby]").length||currentPopover.popover("hide");},hideDelay);}),element.on("mouseenter",function(){setTimeout(function(){if(element.is(":hover")){element.popover("show");var currentPopover=_this2.getBindedPopover(element);currentPopover.on("mouseleave",function(){setTimeout(function(){$(":hover").filter(currentPopover).length||currentPopover.find(".js-popover-tooltip--record[aria-describedby]").length||currentPopover.popover("hide"),$(":hover").filter($(".popover")).length||$(".popover").popover("hide");},hideDelay);});}},manualTriggerDelay);}),app.hidePopoversAfterClick(element);},/**
	 * Register popover.
	 * @param {object} container
...
container.length&&container.remove(),container=$("<div></div>"),container.attr("id",modalId).addClass("modalContainer js-modal-container"),container.one("hidden.bs.modal",function(){container.remove();var backdrop=$(".modal-backdrop"),modalContainers=$(".modalContainer");0==modalContainers.length&&backdrop.length&&backdrop.remove(),0<backdrop.length&&$("body").addClass("modal-open");}),this.modalParams[modalId]=paramsObject;var params={show:!0};1!==$("#backgroundClosingModal").val()&&(params.backdrop=!0),"object"===_typeof(paramsObject)&&(paramsObject.css&&container.css(paramsObject.css),params=$.extend(params,paramsObject)),container.html(data),container.find(".modal").hasClass("static")&&(params.backdrop="static"),$.fn.modal.Constructor.prototype.enforceFocus=function(){$(document).off("focusin.bs.modal")// guard against infinite focus loop
...
if(window.lastModalId="modal_"+Math.random().toString(36).substr(2,9),"object"===_typeof(data)&&null!=data&&!(data instanceof $)){if(null!=data.id&&(window.lastModalId=data.id),cb=data.cb,url=data.url,"undefined"!==data.sendByAjaxCb){var sendByAjaxCb=data.sendByAjaxCb;delete data.sendByAjaxCb;}paramsObject=data,data=data.data;}if("function"==typeof url?("object"===_typeof(cb)&&(paramsObject=cb),cb=url,url=!1):"object"===_typeof(url)&&(cb=function(){},paramsObject=url,url=!1),"function"!=typeof cb&&(cb=function(){}),"function"!=typeof sendByAjaxCb)var sendByAjaxCb=function(){};void 0!==paramsObject&&void 0!==paramsObject.modalId&&(window.lastModalId=paramsObject.modalId),data?app.showModalData(data,paramsObject,cb,url,sendByAjaxCb):$.get(url).done(function(response){app.showModalData(response,paramsObject,cb,url,sendByAjaxCb);});},showModalHtml:function showModalHtml(params){var _params$footer,data="",icon="",footer=null!==(_params$footer=params.footer)&&void 0!==_params$footer?_params$footer:"";params.header&&(params.header="<span class=\"".concat(params.headerIcon," mr-2\"></span>").concat(params.header)),params.footerButtons&&$.each(params.footerButtons,function(i,button){icon=data="",$.each(button.data,function(key,val){data+=" data-".concat(key,"=\"").concat(val,"\"");}),button.icon&&(icon+="<span class=\"".concat(button.icon," mr-2\"></span>")),footer+="<button type=\"button\" class=\"btn ".concat(button["class"],"\" ").concat(data,">").concat(icon).concat(button.text,"</button>");}),footer&&(footer="<div class=\"modal-footer\">".concat(footer,"</div>"));var html="<div class=\"modal\" tabindex=\"-1\" role=\"dialog\"><div class=\"modal-dialog ".concat(params["class"],"\" role=\"document\"><div class=\"modal-content\">\n\t\t<div class=\"modal-header\"><h5 class=\"modal-title js-modal-title\" data-js=\"container\">").concat(params.header,"</h5><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button></div>\n\t\t<div class=\"modal-body js-modal-content text-break ").concat(params.bodyClass,"\" data-js=\"container\">").concat(params.body,"</div>").concat(footer,"</div></div></div>");return params.data=html,app.showModalWindow(params)},registerModalController:function registerModalController(modalId,modalContainer,cb){var windowParent=this.childFrame?window.parent:window;modalId||(modalId=window.lastModalId),modalContainer||(modalContainer=$("#"+modalId+" .js-modal-data"));var moduleName=modalContainer.data("module")||"Base",modalClass=moduleName.replace(":","_")+"_"+modalContainer.data("view")+"_JS";if("undefined"==typeof windowParent[modalClass]&&(modalClass="Base_"+modalContainer.data("view")+"_JS"),"undefined"!=typeof windowParent[modalClass]){var params,instance=new windowParent[modalClass];"function"==typeof cb&&cb(modalContainer,instance),this.modalParams[modalId]&&(params=this.modalParams[modalId]),instance.registerEvents(modalContainer,params),this.modalInstances[modalId]=instance;}},/**
	 * Function which you can use to hide the modal
	 *
	 *  @param {function} callback
	 *  @param {integer} id
	 */hideModalWindow:function hideModalWindow(callback,id){var container;if(container=callback&&"object"===_typeof(callback)?callback:null==id?$(".modalContainer"):$("#"+id),!(0>=container.length)){"function"!=typeof callback&&(callback=function(){});var modalContainer=container.find(".modal");modalContainer.modal("hide");var backdrop=$(".modal-backdrop:last");0==$(".modalContainer").length&&backdrop.length&&backdrop.remove(),modalContainer.one("hidden.bs.modal",callback);}},registerAdditions:function registerAdditions($){$.fn.serializeFormData=function(){for(var instance in CKEDITOR.instances)CKEDITOR.instances[instance].updateElement();var form=$(this),values=form.serializeArray(),data={};values&&$(values).each(function(k,v){var element=form.find("[name=\""+v.name+"\"]");element.is("select")&&null!=element.attr("multiple")?(null==data[v.name]&&(data[v.name]=[]),data[v.name].push(v.value)):data[v.name]=v.value;});// If data-type="autocomplete", pickup data-value="..." set
...
var formError=form.find(".formError:not('.greenPopup'):first");if(0<formError.length){var destination=formError.offset().top;jQuery("html").animate({scrollTop:destination-105},"slow");}},getRecordList:function getRecordList(params,callback){app.showModalWindow(null,params,function(container,modalInstance){modalInstance.addSelectCallBack(function(e){callback(e),app.hideModalWindow("",container.data("modalId"));});});},/**
	 * Open url in top window
	 * @param string url
	 */openUrl:function openUrl(url){window.location===window.top.location?window.location.href=url:window.top.location.href=url;},openUrlMethodPost:function openUrlMethodPost(url,postData){var formHtml="<form action=\""+url+"\" method=\"post\">";$.each(postData,function(index,value){formHtml+="<input type=\"text\" name=\""+index+"\" value=\""+value+"\" />";}),formHtml+="</form>";var form=$(formHtml);$("body").append(form),form.submit();},registerMobileMenu:function registerMobileMenu(container){$(".js-sidebar-btn").on("click",function(){var mobileMenu=container.find(".js-mobile-page"),mobileMenuContent=container.find(".js-mobile-body");mobileMenu.hasClass("c-menu-mobile")?(mobileMenu.removeClass("c-menu-mobile"),mobileMenuContent.removeClass("c-menu-mobile__content")):(mobileMenu.addClass("c-menu-mobile"),mobileMenuContent.addClass("c-menu-mobile__content"));});},errorLog:function errorLog(error,err,errorThrown){console.warn("%cYetiForce debug mode!!!","color: red; font-family: sans-serif; font-size: 1.5em; font-weight: bolder; text-shadow: #000 1px 1px;"),"object"===_typeof(error)&&error.responseText&&(error=error.responseText),"object"===_typeof(error)&&error.statusText&&(error=error.statusText),error&&console.error(error),err&&"error"!==err&&console.error(err),errorThrown&&console.error(errorThrown);},registerSubMenu:function registerSubMenu(){$(".js-submenu-toggler").on("click",function(e){$(e.currentTarget).hasClass("collapsed")||$(e.target).closest(".toggler").length||(window.location=$(e.currentTarget).attr("href"));});},/**
	 * Show left scrollbar.
	 *
	 * @param   {object}  element
	 * @param   {object}  options
	 */showNewScrollbarLeft:function showNewScrollbarLeft(element){var options=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{wheelPropagation:!0};if("undefined"!=typeof element&&element.length){options=Object.assign(this.scrollOptions,options),new PerfectScrollbar(element[0],options);var scrollbarLeftElement=element.children(".ps__rail-y").first();scrollbarLeftElement.css({left:0,right:"auto"}),scrollbarLeftElement.find(".ps__thumb-y").css({left:2,right:"auto"});}},/**
	 * Show notify
	 * @param {object} customParams
	 * @returns {PNotify}
	 */showNotify:function showNotify(customParams){var params={hide:!1},userParams=customParams,type="info";return "string"==typeof customParams&&(userParams={title:customParams}),"undefined"!=typeof customParams.type&&(type=customParams.type),"error"!==type&&(params.hide=!0),PNotify[type]($.extend(params,userParams))},/**
	 * Show confirm modal
	 * @param {object} params
	 * @returns {PNotify}
	 * @returns
	 */showConfirmModal:function showConfirmModal(params){var confirmButtonLabel="JS_OK",rejectedButtonLabel="JS_CANCEL";return "undefined"!=typeof params.confirmButtonLabel&&(confirmButtonLabel=params.confirmButtonLabel),"undefined"!=typeof params.rejectedButtonLabel&&(rejectedButtonLabel=params.rejectedButtonLabel),this.showNotify($.extend({icon:"fas fa-question-circle",closer:!1,sticker:!1,destroy:!1,hide:!1,width:"auto",animateSpeed:"fast",addModalClass:"c-confirm-modal",modules:new Map([].concat(_toConsumableArray(PNotify.defaultModules),[[PNotifyConfirm,{confirm:!0,prompt:!!("showDialog"in params)&&params.showDialog,promptMultiLine:!!("multiLineDialog"in params)&&params.multiLineDialog,buttons:[{text:"<span class=\"fas fa-check mr-2\"></span>"+app.translate(confirmButtonLabel),textTrusted:!0,primary:!0,promptTrigger:!0,click:function click(notice,value,e){params.showDialog&&!value||("undefined"!=typeof params.confirmedCallback&&params.confirmedCallback(notice,value,e),notice.close());}},{text:"<span class=\"fas fa-times mr-2\"></span>"+app.translate(rejectedButtonLabel),textTrusted:!0,click:function click(notice){"undefined"!=typeof params.rejectedCallback&&params.rejectedCallback(notice),notice.close();}}]}]])),stack:new PNotify.Stack({dir1:"down",firstpos1:50,spacing1:0,push:"top",modal:!0,overlayClose:!1})},params))},/**
...
PNotify.defaults.textTrusted=!0,PNotify.defaults.titleTrusted=!0,PNotify.defaults.sticker=!1,PNotify.defaults.styling="bootstrap4",PNotify.defaults.icons="fontawesome5",PNotify.defaults.delay=3e3,PNotify.defaults.stack.maxOpen=10,PNotify.defaults.stack.spacing1=5,PNotify.defaults.stack.spacing2=5,PNotify.defaults.labels.close=app.translate("JS_CLOSE"),PNotify.defaultModules.set(PNotifyBootstrap4,{}),PNotify.defaultModules.set(PNotifyFontAwesome5,{}),PNotify.defaultModules.set(PNotifyMobile,{}),PNotifyConfirm.defaults.buttons=[{text:app.translate("JS_YES"),addClass:"btn-success",primary:!0,promptTrigger:!0,click:function click(notice,value){notice.close(),notice.fire("pnotify:confirm",{notice:notice,value:value});}},{text:app.translate("JS_NO"),addClass:"btn-warning",click:function click(notice){notice.close(),notice.fire("pnotify:cancel",{notice:notice});}}],"undefined"==typeof window.stackContextModal&&(window.stackPage=new PNotify.Stack({dir1:"down",firstpos1:25,context:document.getElementById("page"),modal:!0,maxOpen:1/0})),"undefined"==typeof window.stackContextModal&&(window.stackPage=new PNotify.Stack({dir1:"down",firstpos1:25,context:document.getElementById("page"),modal:!0,maxOpen:1/0}));},registerIframeAndMoreContent:function registerIframeAndMoreContent(){var container=0<arguments.length&&arguments[0]!==void 0?arguments[0]:$(document);container.on("click",".js-more",function(e){e.preventDefault(),e.stopPropagation();var btn=$(e.currentTarget);app.showModalHtml({class:"modal-fullscreen",header:app.translate("JS_FULL_TEXT"),headerIcon:"mdi mdi-overscan",bodyClass:"u-word-break pb-0 pt-1",footerButtons:[{text:app.translate("JS_CANCEL"),icon:"fas fa-times",class:"btn-danger",data:{dismiss:"modal"}}],cb:function cb(modal){if(btn.data("iframe")){var iframe=btn.siblings("iframe"),message=iframe.clone();message[0].hasAttribute("srcdoctemp")&&message.attr("srcdoc",message.attr("srcdoctemp"));var isHidden=iframe.is(":hidden"),height=0;if(iframe.data("height"))height="full"===iframe.data("height")?$(window).height()-185:iframe.data("height");else {var _iframe$contents$heig;isHidden&&(message.css("display",""),iframe.css("display","")),height=null!==(_iframe$contents$heig=iframe.contents().height())&&void 0!==_iframe$contents$heig?_iframe$contents$heig:iframe.contents().find("body").height();}height&&message.height(height),isHidden&&iframe.css("display","none"),modal.find(".js-modal-content").html(message);}else modal.find(".js-modal-content").html(btn.closest(".js-more-content").find(".fullContent").html());}});});},processEvents:!1,registerAfterLoginEvents:function registerAfterLoginEvents(){if(!1===this.processEvents){var processEvents=$("#processEvents");if(0===processEvents.length)return;this.processEvents=JSON.parse(processEvents.val());}if(0!==this.processEvents.length){var event=this.processEvents.shift();switch(event.type){case"modal":AppConnector.request(event.url).done(function(requestData){app.showModalWindow(requestData).one("hidden.bs.modal",function(){app.registerAfterLoginEvents();});}).fail(function(textStatus,errorThrown,jqXHR){app.showNotify({type:"error",title:app.translate("JS_ERROR_ADMIN"),text:jqXHR.responseJSON.error.message,animation:"show"});});break;case"notify":app.showNotify(event.notify),app.registerAfterLoginEvents();break;default:}}},/**
