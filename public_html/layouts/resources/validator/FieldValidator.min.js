...
Base_Validator_Js('Email_Validator_Js',{/**
		 *Function which invokes field validation
		 *@param accepts field element as parameter
		 * @return error if validation fails true on success
		 */invokeValidation:function invokeValidation(field){var emailInstance=new Email_Validator_Js;emailInstance.setElement(field);var response=emailInstance.validate();if(!0!=response)return emailInstance.getError()}},{/**
		 ...
		 * @return true if validation is successfull
		 * @return false if validation error occurs
		 */validate:function validate(){var fieldValue=this.getFieldValue(),negativeRegex=/^[a-zA-Z0-9_.@]{3,32}$/,result=negativeRegex.test(fieldValue);if(!result){var errorInfo=app.translate('JS_CONTAINS_ILLEGAL_CHARACTERS');return this.setError(errorInfo),!1}return !0}}),Base_Validator_Js('Base_PositiveNumber_Validator_Js',{/**
		 *Function which invokes field validation
		 *@param accepts field element as parameter
		 * @return error if validation fails true on success
...
timeFieldValue='11:59 PM';}var dateFieldValue=field.val()+' '+timeFieldValue,dateFormat=field.data('dateFormat');return Base_Helper_Js.getDateInstance(dateFieldValue,dateFormat)}}),Base_Validator_Js('Calendar_greaterThanToday_Validator_Js',{},{/**
		 ...
		 * @return true if validation is successfull
		 * @return false if validation error occurs
		 */validate:function validate(){var field=this.getElement(),fieldValue=field.val(),alphaNumericRegex=/^[\/a-z\\0-9{} _-]*$/i;if(!fieldValue.match(alphaNumericRegex)){var errorInfo=app.translate('JS_CONTAINS_ILLEGAL_CHARACTERS');return this.setError(errorInfo),!1}return !0}}),Base_Validator_Js('Base_InputMask_Validator_Js',{/**
		 *Function which invokes field validation
		 *@param accepts field element as parameter
		 * @return error if validation fails true on success
