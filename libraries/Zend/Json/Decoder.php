...
Core_Loader::import('libraries/Zend/Json/Exception.php');
...
class Zend_Json_Decoder
{
     ...
     * {@link Core_Json::TYPE_ARRAY} and {@link Core_Json::TYPE_OBJECT} for
     * valid values
     * @return void
     */
    protected function __construct($source, $decodeType)
    {
        ...
        if (!in_array($decodeType, array(Core_Json::TYPE_ARRAY, Core_Json::TYPE_OBJECT)))
        {
            $decodeType = Core_Json::TYPE_ARRAY;
        }
     ...
     * return a StdClass object instead, pass {@link Core_Json::TYPE_OBJECT} to
     ...
     * either or {@link Core_Json::TYPE_ARRAY} or
     * {@link Core_Json::TYPE_OBJECT}; defaults to TYPE_ARRAY
     * @return mixed
     * @throws Zend_Json_Exception
     */
    public static function decode($source = null, $objectDecodeType = Core_Json::TYPE_ARRAY)
    {
        if (null === $source) {
